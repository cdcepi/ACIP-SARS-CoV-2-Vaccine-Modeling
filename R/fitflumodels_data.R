#' @name fitflumodels_data
#' @title Internal and external data for fitflumodels
#' @description A collection of data for use with \code{fitflumodels}. Most are used by internal functions but are exposed here for use by
